...
1.1:
  ...
  - Fixed the duplicate "OT8" entry on the map and a logic error preventing item placement in EC7. Discovered by Liquid Cat.
  - Fixed an error in logic that would prevent an item from being placed in EC
