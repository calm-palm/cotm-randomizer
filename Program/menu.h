...
#define MENU_ALLBOSSESANDBATTLEARENA 16
#define MENU_DSSRUNSPEED 17
#define MENU_SKIPCUTSCENES 18
#define MENU_SKIPMAGICITEMTUTORIALS 19
#define MENU_NERFROCWING 20
#define MENU_BATTLEARENAMUSIC 21
